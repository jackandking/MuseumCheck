    ...
    changes: [
        {
            ...
            version: "3.1.0",
            title: "全新亲子关系测评功能",
            description: "当博物馆被标记完成后，在博物馆名称旁显示「亲子测评」按钮。点击进入专业亲子关系测评页面，包含家长和孩子问卷，提供个性化的关系改善建议和评分，所有结果保存在本地存储中。",
            type: "feature"
        },
        {
            date: "2024-12-20",
        ...
        },
        {
            date: "2024-12-20",
            version: "3.0.0",
            title: "全新核心宗旨：专注亲子关系改善",
            description: "重新定义应用核心目标：改善亲子关系是本站核心目标，博物馆亲子游是手段。全面更新专家指导内容，新增可量化的亲子关系改善指标。每次博物馆打卡都会改善亲子关系指标，让所有的亲子关系改善，人民更幸福。用人类最好的亲子关系改善手段和知识来建设本站。",
            type: "feature"
        },
        {
            title: "优化统计和成就显示界面",
            description: "重新设计参观统计和成就按钮区域的视觉布局，改善间距和层次结构，提升整体用户体验。统计数字更加突出，按钮排列更加整齐，移动端适配更加完善。",
            type: "improvement"
        },
        {
            title: "新增清数据功能",
