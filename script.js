...
const RECENT_CHANGES = {
    ...
    changes: [
        {
            title: "系统性博物馆数据质量优化",
            description: "完成全面的博物馆数据去重和质量优化。移除了45个重复/不完整条目，包括40个重复名称、24个重复ID和3个缺失关键字段的博物馆。博物馆数量从302家优化为257家高质量唯一条目，消除了用户搜索困惑和数据不一致问题，显著提升了应用的数据完整性和用户体验。",
            type: "improvement"
        },
        {
            title: "新增清数据功能",
...
const MUSEUMS = [
    ...
    },
    {
        ...
        checklists: {
            parent: {
                '3-6': [
                    '🎫 入馆攻略：免费参观需预约，选择上午10-11点时段人少，儿童科学乐园最受欢迎',
                    '👶 幼儿专线：A馆儿童科学乐园 → B馆探索与发现 → C馆球幕影院（避开复杂展区）',
                    '🧸 安全互动装备：准备湿纸巾、创可贴、小背包装水杯零食，穿防滑运动鞋',
                    '🔬 科学启蒙语言：机器人是"会动的玩具朋友"，实验是"科学魔法"，按钮是"开启奇迹的钥匙"',
                    '⏰ 游览节奏：每个展区15-20分钟，中途休息喝水，总时长1.5小时避免疲劳',
                    '💕 探索鼓励：每当孩子主动按按钮或提问时，立即给予拥抱说"你真是个小科学家！"',
                    '📸 科学记录：孩子操作实验的瞬间 + 与机器人互动合影 + 球幕影院观影留念',
                    '🎁 延伸学习：参观后购买科学小实验套装，回家继续"家庭实验室"游戏',
                    '🌟 庆祝时刻：每完成一个互动实验就和孩子击掌庆祝"我们一起发现了科学的秘密！"',
                ],
                '7-12': [
                    '📱 智能导览：下载"中科馆"APP → 选择"探索路线" → 重点关注人工智能、航天科技展区',
                    '🔬 科学知识储备：了解基础物理（光电声热）、化学（物质变化）、生物（生命现象）原理',
                    '🤖 前沿科技重点：机器人展厅（AlphaGo原理）→ 航天展厅（中国空间站）→ 生命科学展厅',
                    '⚡ 实验安全指导：提醒孩子遵循操作说明，电器类展品谨慎操作，团队合作完成复杂实验',
                    '🧪 STEAM教育融入：科学+技术+工程+艺术+数学的综合体验，培养跨学科思维',
                    '💫 探索对话技巧：当孩子惊叹"太神奇了"时，引导思考"这个现象背后的原理是什么？"',
                    '🎯 互动重点：每个展厅选择2-3个核心实验深度体验，让孩子充分操作和思考',
                    '📚 生活连接：讨论"这些科技如何改变我们的生活"，激发对未来科技的想象',
                    '🎊 成就确认：参观结束时总结"我们今天一起学到的科学原理"，强调共同探索的快乐',
                ],
                '13-18': [
                    '🎓 深度科学准备：预习高中物理化学生物核心概念，了解当代科技发展前沿动态',
                    '🏛️ 科技馆教育理念：理解"体验中学习、探索中成长"的科普教育模式',
                    '🔬 前沿科技专题：量子科学、人工智能、基因工程、新能源、航天科技深度探索',
                    '🌍 全球科技视野：对比中外科技发展，了解中国科技创新在世界舞台的地位',
                    '📊 科学思维训练：观察-假设-实验-结论的科学方法，培养批判性思维和创新思维',
                    '💎 平等科技对话：与青少年探讨"科技与人类未来"、"科技伦理"等深度话题，重视他们的科技见解',
                    '🎯 专业体验路线：选择感兴趣的科技领域深度探索，如AI编程体验、生物实验操作等',
                    '📝 科研素养培养：学会科学观察记录、数据分析、实验报告写作等基本科研技能',
                    '🌟 智慧共创：邀请青少年分享对未来科技的思考，一起畅想科技如何让世界更美好',
                ],
            },
            child: {
                '3-6': [
                    '🤖 机器人好朋友：找到会说话、会跳舞、会画画的机器人，和它们打招呼做朋友',
                    '💧 水的魔法世界：在水流展区玩转水轮、水闸，看水如何"听话"地流来流去',
                    '🔘 神奇按钮探险家：按一按不同颜色的按钮，看看会出现什么有趣的光和声音',
                    '🚂 科学小火车：坐上展厅里的小火车或小汽车，感受运动的快乐',
                    '👂 声音收集家：听听各种奇妙的声音：回音、音乐盒、动物叫声，模仿给爸妈听',
                    '💖 我的科学发现：每发现一个有趣的现象就告诉爸妈，听他们夸奖"你观察得真仔细！"',
                    '🎨 彩色光影游戏：在光学展区看彩虹、影子变化，用手做出不同形状的影子',
                    '🏀 球球运动会：观察各种球的运动轨迹，滚球、弹球、悬浮球，感受物理的神奇',
                    '🎬 神奇电影院：在球幕影院看立体电影，感受被星空和海洋包围的奇妙体验',
                    '🎊 小科学家庆祝：和爸妈一起为完成"科学探险之旅"击掌庆祝，我是最棒的小探险家！',
                ],
                '7-12': [
                    '⚡ 电学实验达人：体验静电起电、简单电路搭建，了解电从哪里来、到哪里去',
                    '🔬 微观世界探索者：通过显微镜观察细胞、晶体，发现肉眼看不到的精彩世界',
                    '🌈 光学现象研究员：探索彩虹形成、光的反射折射，制作简易万花筒或潜望镜',
                    '🚀 航天梦想家：了解火箭发射原理、空间站生活，体验模拟太空漫步',
                    '🧬 生命科学小专家：观察DNA模型、细胞分裂过程，了解生命的奥秘',
                    '🎮 AI编程初体验：学习简单的编程逻辑，让机器人按照指令完成任务，感受创造的快乐',
                    '⚙️ 机械原理工程师：操作齿轮、滑轮、杠杆，理解机械如何让工作变得简单',
                    '📊 数据科学家：收集实验数据，制作图表，学会用数字描述科学现象',
                    '🎬 科学视频制作人：录制实验过程短视频，向同学分享科学发现',
                    '🌟 知识分享大使：当小老师向家人讲解今天学到的科学原理，享受传播知识的成就感',
                ],
                '13-18': [
                    '🔬 前沿科技研究员：深入了解量子计算、基因编辑、人工智能等前沿科技原理和应用',
                    '⚛️ 物理定律验证者：通过高级实验验证牛顿定律、电磁感应等物理原理',
                    '🧪 化学反应分析师：观察和分析化学反应过程，理解分子间的相互作用',
                    '🤖 AI伦理思辨者：体验人工智能应用，思考AI发展对社会伦理的影响',
                    '🌍 可持续发展探索者：了解新能源技术、环保科技，思考科技如何助力可持续发展',
                    '💭 科学哲学思考者：探讨科学与人文的关系，思考科技进步对个人价值观的影响',
                    '📝 科研报告撰写员：选择感兴趣的科技话题，撰写研究性学习报告',
                    '🎯 创新项目设计师：设计解决实际问题的科技方案，培养创新思维和实践能力',
                    '🤝 科技智慧分享者：和家人平等讨论今天的科技感悟，共同思考科技与人生的关系',
                ],
            }
        }
    },
